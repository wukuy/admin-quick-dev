                ...
                <basic-container>
                    <div class="user-info__content">
                        ...
                        <div class="user-info__detail-desc">
                            <p><i class="el-icon-message" /><span>{{ form.yx }}</span></p>
                            <p><i class="el-icon-postcard" /><span>{{ form.gs }} · {{ form.bm }} · {{ form.zw }}</span></p>
                            <p><i class="el-icon-location-information" /><span>{{ form.dz }}</span></p>
                        </div>
                        <div class="user-info__divider" />
                        <h4>标签</h4>
